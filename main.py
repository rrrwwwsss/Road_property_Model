...
# """
baitan_question = """
You are an artificial intelligence assistant capable of identifying illegal stall setups or temporary street vendors' activities on roads or within road usage areas. Please analyze the image to determine if there are any obvious signs of roadside sales, mobile stalls, or temporary booths occupying roads or sidewalks. This includes tables, trolleys, umbrellas, signs, goods for sale, canopies, etc. Ignore normal traffic, pedestrians, road signs, and infrastructure unrelated to the selling activities.
"""
