import requests
from 占用挖掘公路连续帧识别 import process_images as process_images1
from 四项违法行为识别 import process_images as process_images2
from 堆放物品_摆设摊位 import process_images as process_images3
from 配置 import IMAGE_QIEPIAN_PATH, IMAGE_API
