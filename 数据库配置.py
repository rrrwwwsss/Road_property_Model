...
DB_CONFIG = {
    ...
    'user': 'sjtb_test',      # 数据库用户名
    'password': 'sjtbtest#_2025',  # 数据库密码
}
# 控制提交六个违法行为类型到数据库的变量
IS_SUBMIT = True
# 违法行为ID
VIOLATION_DICT = {
    ...
    "设置非公路标志": "219df49be1d44d639fe1f8e9d3aa2e5b",
    "井盖移动或缺失": "dbd1987e748c45ceb5f701345e2c7dd0",
    "利用附属设施悬挂物品": "0cc1ea428e61471a8f7969e047774e9e",
    "堆放物品": "2cf9aa7a9c9d42bb99916f6f379e94a2",
    "摆设摊位": "792409a397d04c3a9252d3f61f0b91fc"
}
# 违法行为详情
TJ_NAME_LIST = {
    "擅自占用、挖掘公路": "占用、挖掘公路行为：是指未依法批准或者不按批准内容实施，在公路路面、路肩、边沟或其附属用地上进行占用或开挖作业的行为。此类行为不仅损害公路设施完整性，还可能影响交通安全和通行效率。",

    "设置非公路标志": "设置非公路标志行为：是指在公路用地范围内擅自设置广告牌、指示牌等非交通标志，容易干扰驾驶员视线，误导交通行为，存在较大安全隐患。",

    "井盖移动或缺失": "井盖移动或缺失行为：是指公路范围内的井盖、雨水篦子等设施因人为或其他原因被移位或丢失，极易导致交通事故，危及车辆与行人通行安全。",

    "利用附属设施悬挂物品": "利用附属设施悬挂物品行为：是指在公路附属设施如路灯杆、电线杆、交通信号杆等处悬挂条幅、广告、装饰物等，影响设施正常功能，干扰交通秩序。",

    "堆放物品": "堆放物品行为：是指在公路及其用地范围内随意堆放建筑材料、生活杂物、废弃物等，妨碍通行、污染环境，可能引发交通事故或次生灾害。",

    "摆设摊位": "摆设摊位行为：是指在公路及其用地范围内擅自设置售卖摊位，占用道路资源，扰乱正常交通秩序，存在较大安全与管理风险。"
}
